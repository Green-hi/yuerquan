...
public class ImgListViewAdapter extends BaseAdapter {
    ...
    protected List<ImgFolderBean> mDatas = new ArrayList<ImgFolderBean>();

    public ImgListViewAdapter(Context context, List<ImgFolderBean> mDatas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImgFolderBean imgFloderBean = mDatas.get(position);
        if(convertView == null)
        {
